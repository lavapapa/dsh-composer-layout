window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ComposerSplitAction({ nativeAvailable, setNativeSplit, settings, sessionId }) {
			...
			const legacySeparator = split && !nativeAvailable && bodyRect !== null && bodyRect.width >= 780 && ownerRef.current !== null ? (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				ref: separatorRef,

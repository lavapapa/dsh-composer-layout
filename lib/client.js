window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region lib/types/client/settings-storage.js
		...
		//#endregion
		//#region lib/types/client/ComposerSplitAction.js
		...
		function ComposerSplitAction({ nativeAvailable, setNativeSplit, settings, sessionId }) {
			...
			const toolbar = (className, style) => (0, react_jsx_runtime.jsxs)("div", {
				ref: toolbarRef,
				className,
				role: "toolbar",
				"aria-label": "输入区域布局",
			...
			const legacySeparator = split && !nativeAvailable && bodyRect !== null && bodyRect.width >= 780 ? (0, react_dom.createPortal)((0, react_jsx_runtime.jsx)("div", {
				ref: separatorRef,
			...
			const bottomTrigger = !split && bodyRect !== null ? (0, react_jsx_runtime.jsx)("button", {
				ref: edgeTriggerRef,
				type: "button",
		...
		//#endregion
		//#region lib/types/client/ComposerLayoutSettingsTab.js
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("h2", { children: translate("title") }), (0, react_jsx_runtime.jsx)("p", { children: translate("description") })]
					}),
					(0, react_jsx_runtime.jsxs)("label", {
						className: ComposerLayoutSettingsTab_module_css_default.row,
						children: [(0, react_jsx_runtime.jsxs)("span", { children: [(0, react_jsx_runtime.jsx)("strong", { children: translate("defaultPlacement") }), (0, react_jsx_runtime.jsx)("small", { children: translate("defaultPlacementHint") })] }), (0, react_jsx_runtime.jsxs)("select", {
					...
					(0, react_jsx_runtime.jsxs)("label", {
						className: ComposerLayoutSettingsTab_module_css_default.row,
						children: [(0, react_jsx_runtime.jsxs)("span", { children: [(0, react_jsx_runtime.jsx)("strong", { children: translate("rememberPlacement") }), (0, react_jsx_runtime.jsx)("small", { children: translate("rememberPlacementHint") })] }), (0, react_jsx_runtime.jsx)("input", {
							type: "checkbox",
					...
					(0, react_jsx_runtime.jsxs)("label", {
						className: ComposerLayoutSettingsTab_module_css_default.row,
						children: [(0, react_jsx_runtime.jsxs)("span", { children: [(0, react_jsx_runtime.jsx)("strong", { children: translate("bottomHandleHoverOnly") }), (0, react_jsx_runtime.jsx)("small", { children: translate("bottomHandleHoverOnlyHint") })] }), (0, react_jsx_runtime.jsx)("input", {
							type: "checkbox",
					...
					(0, react_jsx_runtime.jsxs)("label", {
						className: ComposerLayoutSettingsTab_module_css_default.row,
						children: [(0, react_jsx_runtime.jsxs)("span", { children: [(0, react_jsx_runtime.jsx)("strong", { children: translate("defaultWidthPreset") }), (0, react_jsx_runtime.jsx)("small", { children: translate("defaultWidthPresetHint") })] }), (0, react_jsx_runtime.jsxs)("select", {
		...
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.input.overlay", () => {
				...
				const nativeLayout = () => ctx.get("conversationLayout");
				const setNativeSplit = (active) => {
					releasePlacement?.();
					releasePlacement = void 0;
					const native = nativeLayout();
					if (active && native !== void 0) releasePlacement = native.register({ composerPlacement: "inline-end" });
				};
				const disposeEntry = ctx.slots.register({
					...
					order: 30,
					inject: () => ({
						nativeAvailable: nativeLayout() !== void 0,
						setNativeSplit,
						settings
					})
				}, ComposerSplitAction);
